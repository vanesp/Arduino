...
void SetDaylight()
  ...
  DOY=((Time.Month-1)*304)/10+Time.Date;// schrikkeljaar berekening niet nodig, levert slechts nauwkeurigheidsafwijking van één minuut.
  index=(DOY/10);
...
void DS1307_save(void)
  ...
  for(byte i=0; i<7; i++)Wire.write(rtc[i]);
