 ...
 * Serial.Print neemt veel  in beslag.
 \*********************************************************************************************/
    ...
    if(P1!=P_NOT)
      ...
      switch(P1)
        ...
        case P_VALUE:
          ...
          break;
        case P_KAKU:
          Serial.write('A'+((Par1&0xf0)>>4)); //  A..P printen.
...
void PrintTerm()
  ...
  if(SERIAL_TERMINATOR_1)Serial.write(SERIAL_TERMINATOR_1);
  if(SERIAL_TERMINATOR_2)Serial.write(SERIAL_TERMINATOR_2);
  }
...
void PrintDateTime(void)
    ...
    for(byte x=0;x<=2;x++)Serial.write(*(Text(Text_04)+(Time.Day-1)*3+x));
    PrintChar(' ');
