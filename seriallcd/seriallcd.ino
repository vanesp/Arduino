...
int year = 13;  // Enter the current year here, 11 = 2011
int month = 3;  // Enter the current month here, 6 = June
int date = 9;  // Enter the current date here
int day = 6;  // 0 = Sunday, 6 = Saturday
int hours = 18;  // Enter the hours here
int minutes = 10;  // Enter the minutes here
