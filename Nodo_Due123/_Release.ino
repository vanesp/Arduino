...
- Versie van Peter van Es
- in/output weer als origineel
- Voor gebruik in Nodo Arduino Small met commando interface
- baud rate 19200

Release v1.2.1

- Versie van Peter van Es
- in/output korter gemaakt
...
- Versnellen verwerking RF signalen:
  ...
  * verzenden Nodo     : 2,7 commando's per seconde.
